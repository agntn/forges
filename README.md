...
⚒️ Four forges, ten resources, 42 agent tools. You ask for a pull request, you get a pull request.
...
- 🤖 **42 tools, three surfaces.** MCP, Pi and OMP share the executors. Seven tools write to the host.
...
MCP, Pi and OMP all hit the same 42 tools. Seven write to the host, so ask `forges_users_authenticated` who you are before a model does, details in the [Agents](https://forges.agntn.dev/guide/agents) guide.
