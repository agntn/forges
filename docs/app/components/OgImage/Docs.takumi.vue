...
/** Overrides the Docus template of the same name; Takumi has no CSS variables, so theme tokens are literals. */
...
const CHIPS = ["repos_get", "issues_list", "pull_requests_get", "threads_list"];
</script>
  ...
  >
    ...
    <div class="flex items-center justify-between w-full">
      <div class="flex items-center">
        <div class="w-[10px] h-[10px] rounded-full" style="background-color: #fda4af" />
        <p
