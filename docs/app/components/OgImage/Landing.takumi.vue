...
const TAGLINE =
  "Repositories, issues, pull requests, review threads, commits and CI from four platforms, in one shape.";

const { name: siteName } = useSiteConfig();

const PROVIDERS = ["GitHub", "GitLab", "Gitea", "GitBucket", "Forgejo"];
</script>
    ...
    <div
      ...
      style="
        background-image: radial-gradient(
          ellipse at top,
          rgba(253, 164, 175, 0.18) 0%,
          rgba(253, 164, 175, 0.05) 45%,
          transparent 70%
        );
      "
    />
      ...
      <div class="flex items-center">
        <div
          ...
          :style="{
            ...
            color: index === 0 ? '#fda4af' : '#a5b0bc',
            backgroundColor: '#11141a',
            border: index === 0 ? '1px solid rgba(253, 164, 175, 0.5)' : '1px solid #262c35',
            lineHeight: '36px',
          }"
        >
          {{ provider }}
