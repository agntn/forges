...
| issues             | `GET /repos/:owner/:repo/issues`, `GET /search/issues`, `POST /repos/:owner/:repo/issues`, `…/issues/:number/comments`       |
| pull requests      | `GET /repos/:owner/:repo/pulls`, `…/pulls/:number/files`, `…/commits/:sha/check-runs`, `…/commits/:sha/status`               |
| pull request edits | `PATCH …/pulls/:number`, `POST`/`DELETE …/issues/:number/assignees`, `POST …/issues/:number/labels`, `DELETE …/labels/:name` |
