...
Leave out `state` and the search covers open and closed items on every platform. Gitea on its own answers with open ones only, so forges asks it for all of them.
