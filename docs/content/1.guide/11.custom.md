...
Contribution templates, code search, CI runs, commit lists, releases, issue and pull request search, pull request files, pull request checks and pull request reviews all have defaults that reject with a `ForgesError` of status 501 and a sentence naming the operation. Implement what your platform has. The rest fails honestly instead of pretending.
