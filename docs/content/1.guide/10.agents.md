...
title: Agents
icon: i-lucide-bot
description: The same thirty-one tools over MCP, the Pi extension and the OMP extension, what they hold back, and how tokens and hosts stay out of a model's hands.
---

## Thirty-one tools, three surfaces
